  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mt-10 text-xl font-bold text-ink">Current Nigeria CPINs: Quick Reference Table</h2>
        <div className="mt-4">
          <ResponsiveTableWrap>
            <table className="w-full min-w-[600px] border-collapse text-sm">
              <caption className="mb-3 text-left text-base font-semibold text-ink">
                Nigeria CPIN quick reference for UK asylum practitioners (2025 to 2026)
              </caption>
              <thead>
                <tr className="border-b border-border bg-stone">
                  <th className="px-4 py-3 text-left font-semibold text-ink">CPIN Topic</th>
                  <th className="px-4 py-3 text-left font-semibold text-ink">Version/Date</th>
                  <th className="px-4 py-3 text-left font-semibold text-ink">Key Finding</th>
                </tr>
              </thead>
              <tbody>
                {cpinQuickReference.map((row) => (
                  <tr key={row.topic} className="border-b border-border">
                    <td className="px-4 py-3 text-mute">{row.topic}</td>
                    <td className="px-4 py-3 text-mute">{row.versionDate}</td>
                    <td className="px-4 py-3 text-mute">{row.keyFinding}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section id="sogiesc" className="scroll-mt-24 mt-10">
          <h2 className="text-xl font-bold text-ink">June 2025 SOGIESC CPIN</h2>
          <p className="mt-4 text-mute leading-relaxed">
            ...
            <Link href="/asylum-profiles/lgbtq-asylum-nigeria" className="font-semibold text-hibiscus hover:underline">
              LGBTQ+ asylum profile
            </Link>{" "}
            and{" "}
            <Link href="/guides/lgbtq-nigeria-asylum-guide" className="font-semibold text-hibiscus hover:underline">
        ...
        <section id="ipob-separatist" className="scroll-mt-24 mt-10">
          <h2 className="text-xl font-bold text-ink">April 2026 IPOB & Separatist Groups CPIN</h2>
          <p className="mt-4 text-mute leading-relaxed">
            ...
            <Link href="/asylum-profiles/ipob-biafra" className="font-semibold text-hibiscus hover:underline">
              IPOB & Biafra profile
            </Link>{" "}
            and{" "}
            <Link href="/guides/ipob-biafra-expert-guide" className="font-semibold text-hibiscus hover:underline">
        ...
        <section id="euaa-2026" className="scroll-mt-24 mt-10">
          <h2 className="text-xl font-bold text-ink">EUAA Country Guidance Nigeria 2026</h2>
          <p className="mt-4 text-mute leading-relaxed">
        ...
        <section id="actors-of-protection" className="scroll-mt-24 mt-10">
          <h2 className="text-xl font-bold text-ink">August 2024 Actors of Protection CPIN</h2>
          <p className="mt-4 text-mute leading-relaxed">
            ...
            <Link href="/asylum-profiles/actors-of-protection" className="font-semibold text-hibiscus hover:underline">
        ...
        <section id="internal-relocation" className="scroll-mt-24 mt-10">
          <h2 className="text-xl font-bold text-ink">Internal Relocation: Lagos & Abuja</h2>
          <p className="mt-4 text-mute leading-relaxed">
            ...
            <Link href="/asylum-profiles/internal-relocation-lagos" className="font-semibold text-hibiscus hover:underline">
              internal relocation profile
            </Link>{" "}
            and{" "}
            <Link href="/services/internal-relocation-analysis" className="font-semibold text-hibiscus hover:underline">
        ...
        <h2 className="mt-10 text-xl font-bold text-ink">How Expert Reports Relate to CPINs</h2>
        <p className="mt-4 text-mute leading-relaxed">
        ...
        <p className="mt-4 text-mute leading-relaxed">
          ...
          <Link href="/services/cpin-challenge" className="font-semibold text-hibiscus hover:underline">
            CPIN challenge reports service
          </Link>
          .
        </p>

        <h2 className="mt-10 text-xl font-bold text-ink">Legal Aid Compatibility</h2>
        <p className="mt-4 text-mute leading-relaxed">
        ...
        <div className="mt-10 rounded-[8px] border border-border bg-stone p-6">
          <h3 className="font-semibold text-ink">All Nigerian Asylum Profiles</h3>
          <ul className="mt-4 grid gap-2 text-sm sm:grid-cols-2">
            <li><Link href="/asylum-profiles/lgbtq-asylum-nigeria" className="text-hibiscus hover:underline">LGBTQ+ Asylum Nigeria</Link></li>
            <li><Link href="/asylum-profiles/ipob-biafra" className="text-hibiscus hover:underline">IPOB & Biafra Separatists</Link></li>
            <li><Link href="/asylum-profiles/boko-haram-northeast" className="text-hibiscus hover:underline">Boko Haram North-East</Link></li>
            <li><Link href="/asylum-profiles/fgm-gbv" className="text-hibiscus hover:underline">FGM & Gender-Based Violence</Link></li>
            <li><Link href="/asylum-profiles/trafficking-juju" className="text-hibiscus hover:underline">Trafficking & Juju Rituals</Link></li>
            <li><Link href="/asylum-profiles/actors-of-protection" className="text-hibiscus hover:underline">Actors of Protection</Link></li>
            <li><Link href="/asylum-profiles/internal-relocation-lagos" className="text-hibiscus hover:underline">Internal Relocation Lagos & Abuja</Link></li>
            <li><Link href="/asylum-profiles/political-persecution" className="text-hibiscus hover:underline">Political Persecution</Link></li>
          </ul>
        </div>

        <div className="mt-8 rounded-[8px] border border-border bg-stone p-6">
          <h3 className="font-semibold text-ink">Solicitor Guides</h3>
          <ul className="mt-4 space-y-2 text-sm">
            {guides.map((g) => (
              <li key={g.slug}>
                <Link href={`/guides/${g.slug}`} className="text-hibiscus hover:underline">
                  {g.h1.replace(/:.*$/, "")}
                </Link>
              </li>
            ))}
