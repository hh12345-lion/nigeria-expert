  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0D3B2E]">Current Nigeria CPINs: Quick Reference Table</h2>
        <div className="mt-4">
          <ResponsiveTableWrap>
            <table className="w-full min-w-[600px] border-collapse text-sm">
              ...
              <thead>
                <tr className="border-b border-[#D1E3D8] bg-[#F7F9F7]">
                  <th className="px-4 py-3 text-left font-semibold text-[#0D3B2E]">CPIN Topic</th>
                  <th className="px-4 py-3 text-left font-semibold text-[#0D3B2E]">Version/Date</th>
                  <th className="px-4 py-3 text-left font-semibold text-[#0D3B2E]">Key Finding</th>
                </tr>
              </thead>
              <tbody>
                {cpinQuickReference.map((row) => (
                  <tr key={row.topic} className="border-b border-[#D1E3D8]">
        ...
        <section id="sogiesc" className="scroll-mt-24 mt-10">
          <h2 className="text-xl font-bold text-[#0D3B2E]">June 2025 SOGIESC CPIN</h2>
          <p className="mt-4 text-[#374151] leading-relaxed">
            ...
            <Link href="/asylum-profiles/lgbtq-asylum-nigeria" className="font-semibold text-[#C8922A] hover:underline">
              LGBTQ+ asylum profile
            </Link>{" "}
            and{" "}
            <Link href="/guides/lgbtq-nigeria-asylum-guide" className="font-semibold text-[#C8922A] hover:underline">
        ...
        <section id="ipob-separatist" className="scroll-mt-24 mt-10">
          <h2 className="text-xl font-bold text-[#0D3B2E]">April 2026 IPOB & Separatist Groups CPIN</h2>
          <p className="mt-4 text-[#374151] leading-relaxed">
            ...
            <Link href="/asylum-profiles/ipob-biafra" className="font-semibold text-[#C8922A] hover:underline">
              IPOB & Biafra profile
            </Link>{" "}
            and{" "}
            <Link href="/guides/ipob-biafra-expert-guide" className="font-semibold text-[#C8922A] hover:underline">
        ...
        <section id="euaa-2026" className="scroll-mt-24 mt-10">
          <h2 className="text-xl font-bold text-[#0D3B2E]">EUAA Country Guidance Nigeria 2026</h2>
          <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <section id="actors-of-protection" className="scroll-mt-24 mt-10">
          <h2 className="text-xl font-bold text-[#0D3B2E]">August 2024 Actors of Protection CPIN</h2>
          <p className="mt-4 text-[#374151] leading-relaxed">
            ...
            <Link href="/asylum-profiles/actors-of-protection" className="font-semibold text-[#C8922A] hover:underline">
        ...
        <section id="internal-relocation" className="scroll-mt-24 mt-10">
          <h2 className="text-xl font-bold text-[#0D3B2E]">Internal Relocation: Lagos & Abuja</h2>
          <p className="mt-4 text-[#374151] leading-relaxed">
            ...
            <Link href="/asylum-profiles/internal-relocation-lagos" className="font-semibold text-[#C8922A] hover:underline">
              internal relocation profile
            </Link>{" "}
            and{" "}
            <Link href="/services/internal-relocation-analysis" className="font-semibold text-[#C8922A] hover:underline">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0D3B2E]">How Expert Reports Relate to CPINs</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0D3B2E]">Legal Aid Compatibility</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <div className="mt-10 rounded-[8px] border border-[#D1E3D8] bg-[#F7F9F7] p-6">
          <h3 className="font-semibold text-[#0D3B2E]">All Nigerian Asylum Profiles</h3>
          <ul className="mt-4 grid gap-2 text-sm sm:grid-cols-2">
            <li><Link href="/asylum-profiles/lgbtq-asylum-nigeria" className="text-[#C8922A] hover:underline">LGBTQ+ Asylum Nigeria</Link></li>
            <li><Link href="/asylum-profiles/ipob-biafra" className="text-[#C8922A] hover:underline">IPOB & Biafra Separatists</Link></li>
            <li><Link href="/asylum-profiles/boko-haram-northeast" className="text-[#C8922A] hover:underline">Boko Haram North-East</Link></li>
            <li><Link href="/asylum-profiles/fgm-gbv" className="text-[#C8922A] hover:underline">FGM & Gender-Based Violence</Link></li>
            <li><Link href="/asylum-profiles/trafficking-juju" className="text-[#C8922A] hover:underline">Trafficking & Juju Rituals</Link></li>
            <li><Link href="/asylum-profiles/actors-of-protection" className="text-[#C8922A] hover:underline">Actors of Protection</Link></li>
            <li><Link href="/asylum-profiles/internal-relocation-lagos" className="text-[#C8922A] hover:underline">Internal Relocation Lagos & Abuja</Link></li>
            <li><Link href="/asylum-profiles/political-persecution" className="text-[#C8922A] hover:underline">Political Persecution</Link></li>
          </ul>
        </div>

        <div className="mt-8 rounded-[8px] border border-[#D1E3D8] bg-[#F7F9F7] p-6">
          <h3 className="font-semibold text-[#0D3B2E]">Solicitor Guides</h3>
