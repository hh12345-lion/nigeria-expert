  ...
  return (
    <>
      ...
      <PageShell title="Cookie Policy" subtitle="Last updated: May 2026" breadcrumbs={crumbs}>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0D3B2E]">What are cookies?</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0D3B2E]">How we use cookies</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0D3B2E]">Cookie categories</h2>
        <div className="mt-4 space-y-4">
          {(Object.keys(CATEGORY_META) as Array<keyof typeof CATEGORY_META>).map((key) => {
            const meta = CATEGORY_META[key];
            return (
              <section key={key} className="rounded-[8px] border border-[#D1E3D8] p-4">
                <h3 className="font-semibold text-[#0D3B2E]">{meta.label}</h3>
                <p className="mt-2 text-sm text-[#374151]">{meta.description}</p>
                {meta.required && (
                  <p className="mt-2 text-xs font-medium text-[#0D3B2E]">Always active</p>
                )}
              </section>
            );
          })}
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0D3B2E]">Third-party services</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0D3B2E]">Your choices</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#0D3B2E]">Browser controls</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
