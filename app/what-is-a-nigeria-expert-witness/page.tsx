  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1C2D5A]">What Does a Nigeria Expert Report Cover?</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1C2D5A]">When Should Solicitors Instruct?</h2>
        <p className="mt-4 text-[#4D5768] leading-relaxed">
        ...
        <Link
          href="/contact"
          className="mt-8 inline-flex min-h-[44px] items-center rounded-[4px] bg-[#D96A1F] px-6 py-3 font-semibold text-white"
        >
          Instruct an Expert
        </Link>
      </PageShell>
