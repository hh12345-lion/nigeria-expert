...
const inputClass =
  "w-full min-w-0 rounded-[4px] border border-[#D1E3D8] px-4 py-3 text-base text-[#374151] focus:border-[#0D3B2E] focus:outline-none focus:ring-1 focus:ring-[#0D3B2E] min-h-[44px]";
